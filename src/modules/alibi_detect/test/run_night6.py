...
def main():
    ...
    myTAE.import_detector(path='/home/ubuntu/image-drift-monitoring/config/detectors/Camelyon/TAE/LSDD/camelyon_TAE_5000_10121_LSDD',detector_type='LSDD')
    ...
    for i in range(10,210,10):
        ...
        res = myTAE.make_prediction(target_data=test_i, detector_type='LSDD')
