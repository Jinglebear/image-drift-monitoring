...
def main():
    ...
    df_new.to_excel('iwildcam_uae_ks_results.xlsx')
    ...
    for i in range(10,210,10):
        ...
        for j in range(5,105,5):
            ...
            df_new.loc['Size {}'.format(i)]['{}'.format(j)] = res['data']['is_drift']
    df_new.to_excel('iwildcam_uae_cvm_results.xlsx')
    ...
    for i in range(10,210,10):
        ...
        for j in range(5,40,5):
            ...
            df_new.loc['Size {}'.format(i)]['{}'.format(j)] = res['data']['is_drift']
    df_new.to_excel('iwildcam_uae_mmd_results.xlsx')
    ...
    for i in range(10,210,10):
        ...
        for j in range(5,40,5):
            ...
            df_new.loc['Size {}'.format(i)]['{}'.format(j)] = res['data']['is_drift']
    df_new.to_excel('iwildcam_uae_lsdd_results.xlsx')
# ======================================================================================
# call
