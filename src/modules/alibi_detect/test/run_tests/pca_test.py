...
def main():
    ...
    for name in ['rxrx1', 'iwildcam', 'globalwheat', 'camelyon']:
        ...
        for i in ['KS', 'CVM', 'MMD', 'LSDD']:
            ...
            myPCA.import_detector(path='{}/{}_pca_{}'.format(
            ...
            df_new.to_excel(
                '{}_pca_{}_results_recurring.xlsx'.format(DATASET_NAME, i))
        ...
        for i in ['KS', 'CVM', 'MMD', 'LSDD']:
            ...
            df_new.to_excel(
                '{}_pca_{}_results_incremental.xlsx'.format(DATASET_NAME, i))
        ...
        for i in ['KS', 'CVM', 'MMD', 'LSDD']:
            ...
            df_new.to_excel(
                '{}_pca_{}_results_sudden.xlsx'.format(DATASET_NAME, i))
