...
def main():
        ...
        df_new.to_excel('rxrx1_uae_ks_results_incremental.xlsx')
        ...
        for j in range(20,120,20):
                ...
                for i in range(5,105,5):
                        ...
                        df_new.loc['{}% OOD Bilder'.format(i)]['{}'.format(j)] = res['data']['is_drift']
        df_new.to_excel('rxrx1_uae_cvm_results_incremental.xlsx')
        ...
        for j in range(20,120,20):
                ...
                for i in range(5,105,5):
                        ...
                        df_new.loc['{}% OOD Bilder'.format(i)]['{}'.format(j)] = res['data']['is_drift']
        df_new.to_excel('rxrx1_uae_mmd_results_incremental.xlsx')
        ...
        for j in range(20,120,20):
                ...
                for i in range(5,105,5):
                        ...
                        df_new.loc['{}% OOD Bilder'.format(i)]['{}'.format(j)] = res['data']['is_drift']
        df_new.to_excel('rxrx1_uae_lsdd_results_incremental.xlsx')
# ======================================================================================
# call
